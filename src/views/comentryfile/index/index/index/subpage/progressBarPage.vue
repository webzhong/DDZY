...
<script>
    ...
    const tabmap = {weekNameAll:"带电作业计划-周",mothNameAll:'带电作业计划-月',dayNameAll:'带电作业计划-日',weekNameAll:'风险等级-周',fengxianNameAll:'风险等级-日'};
    export default{
        props:{
            itemList:{}
        },
        ...
        methods: {
            ...
            handleTabsShow(){
                var _this = this;
                bus.$on('progressModelShow',function(data){
                    console.log(data)
            ...
            handleTabAdd(){
                this.tabindex++;
                console.log('点击增加时',this.tabindex)
            ...
            handleTabRemove(name){
                ...
                if(this.tabsArr.length===0){
                    this.$emit('progressbar',{isShow:false});
                    return
                }
                this.getStore(this.tabsArr[this.tabsArr.length-1])
                console.log('Removename',name,this.tabsArr)
            },
            // 这里拿到表格的数据、分页信息等
            tableDataArrShow() {
                // AXIOS.apiMethod('/jsonServer/data.json','get',params,function(res){
                ...
                axios.get('/jsonServer/data.json').then((response) =>{
                        ...
                        }else if(this.classMing == 'weekNameAll' || this.classMing  == 'name2-3' || this.classMing == 'name2-4' || this.classMing == 'name2-1' || this.classMing == 'name2-2'){
                        ...
                        //console.log(this.classMing, tableData)
                        /*if(this.fengxian ==true || this.showjingdu==true){
                           tableData = response.data.data2;
...
//              console.log("tableData数据" +tableData)
//			}else{
//              var tableData = tabledata;
//			}
//			this.itemListArray=tableData;
//			this.pagelistArr = [12, 1, this.pageSize]; // 表格分页[总条数,当前页【最小是1】,每页条数]
//			this.loading = false; // 获取数据后关闭loding
//			this.tableDataArr = tableData; // 表格的数据
            },
            // 获取表格的表头
            ...
            getYecharts(){
                var _this =this;
                if(this.classMing =="dayNameAll" || this.classMing == 'fengxianNameAll'|| this.classMing=='name1-1'||this.classMing=='name1-2' ||this.classMing=='name11-1'||this.classMing=='name11-2'){
                    var data = [
                        {
                            "name": "朝阳","value": 4
                        },{
                    ...
                    var min = 0;
                    var max=50;
                }else if(this.classMing == 'weekNameAll' || this.classMing=='name2-1'||this.classMing=='name2-2'|| this.classMing=='name2-3'||this.classMing=='name2-4'||this.classMing == 'fengxianNameAll'||this.classMing =='name12-1'||this.classMing =='name12-2'){
                    var data = [
                        {
                            "name": "朝阳","value": 20
                        },{
